...
def lambda_handler(event, context):
    ...
    ud_critical_phrase_list = ["CV", "data", "science", "engineering", "Engineering"]
    ...
    # --- Insert your code here ---
    # Do not change the name of this variable
    email_text = email_response(dec_dict['name'], ud_critical_phrase_list, key_phrases, sentiment)
